<?php
  ...
  // Kalo misalnya akun dengan level lain selain admin, bakal dilempar lagi ke halamannya
  if (!admin()) {
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto pe-3 pt-20 me-5">
            ...
            <li class="nav-item pe-3">
              <a class="nav-link" style="color: #006dff" data-bs-toggle="modal" data-bs-target="#layanan">Daftar Layanan</a>
            </li>
            <li class="nav-item pe-3">
              <a class="nav-link" style="color: #006dff" data-bs-toggle="modal" data-bs-target="#LaporanBahan">Data Bahan Laundry</a>
            </li>
            <li class="nav-item pe-3">
              <a class="nav-link" style="color: #006dff" data-bs-toggle="modal" data-bs-target="#daftarMetode">Daftar Metode</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container text-center">
        <div class="row align-items-start">
          <div class="col-sm-4 mb-3">
            <!-- Tampil Layanan -->
            <?php include 'layanan/tampil_layanan.php' ?> 
          </div>
          <div class="col-sm-4 mb-3">
            <!-- Laporan Bahan Laundry (Manager - Admin) -->
            <?php include 'laporan_bahan/laporan.php' ?>
          </div>
          <div class="col-sm-4 mb-3">
            <!-- Daftar Transaksi (Kasir) -->
            <?php include 'riwayat_transaksi/riwayat_transaksi.php' ?>
          </div>
          <div class="col-sm-4 mb-3">
            <!-- Ulasan -->
          ...
          <div class="col-sm-4 mb-3">
            <!-- Daftar Metode -->
            <?php include 'metode/daftar_metode.php'; ?>
          </div>
          <div class="col-sm-4 mb-3">
            <!-- Profile -->
